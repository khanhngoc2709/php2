...
class sinhVien{
    ...
    {
        echo "Tên sinh viên : $this->ten";
        echo "<br> Lớp sinh viên : $this->lop";
        echo "<br> Mã sinh viên : $this->maSinhVien";
        echo "<br> Số dư sinh viên : $this->soDuTaiKhoan";
        echo "<br> Năm sinh viên : $this->namNhapHoc <br>"; 
        echo"
